...
void Unified::addClangSystemIncludeArgs(const llvm::opt::ArgList &DriverArgs,
                                        llvm::opt::ArgStringList &CC1Args) const {
  // Add system include paths under the unified sysroot
 ...
 void Unified::addLibCxxIncludePaths(const llvm::opt::ArgList &DriverArgs,
                             llvm::opt::ArgStringList &CC1Args) const {
 ...
 void Unified::AddCXXStdlibLibArgs(const llvm::opt::ArgList &Args,
 ...
 void unified::Assembler::ConstructJob(Compilation &C, const JobAction &JA,
 ...
 void unified::Linker::ConstructJob(Compilation &C, const JobAction &JA,
                         const InputInfo &Output, const InputInfoList &Inputs,
                         const llvm::opt::ArgList &Args,
                         const char *LinkingOutput) const{
     const toolchains::Unified &ToolChain = static_cast<const toolchains::Unified&>(getToolChain());
     ArgStringList CmdArgs;
